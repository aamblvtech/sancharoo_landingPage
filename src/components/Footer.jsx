...
export default function Footer() {
  const navigateToPrivacy = (e, tab) => {
    ...
    window.history.pushState({}, "", paths[tab] || "/privacy");
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pt-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <span
              ...
              aria-label="twitter"
              aria-disabled="true"
              className="w-10 h-10 grid place-items-center rounded-full bg-white/5 border border-white/10 opacity-50"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
